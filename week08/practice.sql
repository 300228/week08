...
('root', 'password', '管理員', 'M', '2025-10-21 14:05:55'),
('teacher', 'pw1', '老師', 'T', '2025-10-21 14:05:55'),
...
--
ALTER TABLE `job`
  MODIFY `postid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;COMMIT;
